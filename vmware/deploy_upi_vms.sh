...
govc vm.create -on=false -c=10 -m=24576 -disk=160GB -iso-datastore=gym-550000532v-ia4savhl-storage -iso=isos/discovery_image_upicluster.iso i1
govc vm.change -e="disk.enableUUID=1" -vm=i1

govc vm.create -on=false -c=10 -m=24576 -disk=160GB -iso-datastore=gym-550000532v-ia4savhl-storage -iso=isos/discovery_image_upicluster.iso i2
govc vm.change -e="disk.enableUUID=1" -vm=i2

govc vm.create -on=false -c=10 -m=24576 -disk=160GB -iso-datastore=gym-550000532v-ia4savhl-storage -iso=isos/discovery_image_upicluster.iso i3
